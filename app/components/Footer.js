...
const Footer = () => {
  ...
  <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    <div className="w-full md:w-1/3 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left mb-10 md:mb-0">
      <Link href="/">
        <Image src="/images/Marketminds_Logo.png" alt='Logo' width={150} height={150} />
      </Link>
      <p className="mt-2 text-sm text-gray-500">Air plant banjo lyft occupy retro adaptogen indego</p>
    </div>

    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center md:w-2/3">
      <div className="lg:w-1/3 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          ...
          <li>
            <a href='#how-it-works' className="text-gray-600 hover:text-gray-800">Why Choose Us</a>
          </li>
        </nav>
      </div>
  ...
  <div className="bg-gray-100">
    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p className="text-gray-500 text-sm text-center sm:text-left">© 2024 MarketMinds —
        <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">@wezenite</a>
      </p>
